from POM_Focus.LambdaTest.pages.base_page import BasePage
from POM_Focus.LambdaTest.pages.my_account_page import MyAccountPage
from POM_Focus.LambdaTest.utilities.locators import ChangePasswordLocatorFields
...
class ChangePasswordPage(BasePage):
    ...
    def change_password(self, password, confirm_password):
        ...
        self.set(self.locate.confirm_password, confirm_password)
